...
![Созданная таблица](pictures/cars.PNG "Машины")

**1.    Создайте представление, в которое попадут автомобили стоимостью  до 25 000 долларов.**

![Пример решения](pictures/cost_less_25000.PNG "Машины до 25000")
...
![Пример решения](pictures/cost_increased_30000.PNG "Машины до 30000")

---

**3.    Создайте представление, в котором будут только автомобили марки “Skoda” и “Audi”.**

![Пример решения](pictures/select_brands.PNG "Марки “Skoda” и “Audi”")

---

**Таблица train_shedule.**

![Созданная таблица](pictures/station_time.PNG "Время прибытия на станцию")
...
![Пример решения](pictures/time_between_stations.PNG "Обновленное расписание поездов")
...
![Пример решения](pictures/friends_user_1.PNG "Друзья первого пользователя")

---

- **Создайте представление, в котором будут выводится все сообщения, в которых принимал участие пользователь с id = 1.**

![Пример решения](pictures/all_messages_id1.PNG "Все сообщения с первым пользователем")

---

- **Получите список медиафайлов пользователя с количеством лайков(media m, likes l ,users u).**

![Пример решения](pictures/media_with_likes.PNG "Список медиафайлов пользователей с количеством лайков")
...
![Пример решения](pictures/adults_users_20.PNG "Пользователи не старше 20 лет")
